...
// Isolated Typewriter to prevent entire Hero tree re-rendering on every letter
const TypewriterRole = memo(function TypewriterRole() {
    ...
    <section className="hero" id="home">
      ...
      <div className={`hero__container container ${loaded ? 'hero__container--loaded' : ''}`}>
        <div className="hero__content">
          ...
          {/* Luxury Status Badge */}
          <div className="hero__badge hero__entrance hero__entrance--1">
          ...
          {/* Minimalist Handwritten Scroll Cue */}
          <div 
            className="hero__scroll-cue hero__entrance hero__entrance--6" 
          ...
          >
            ...
            <ChevronDown size={13} className="hero__scroll-chevron" />
          </div>
